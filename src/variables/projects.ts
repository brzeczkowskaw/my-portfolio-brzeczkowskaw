export const projects = [
  ...
  {
    name: "Leagues Directory",
    text: "Using TheSportsDB API app is showing the list of sport leagues. User can filter list by league's name and sport category. When clicking on the league card, the first season's logo of choosen league is presented.",
    subtext: null,
    points: null,
    demo: "https://leagues-directory.netlify.app/",
    github: "https://github.com/brzeczkowskaw/sporty-group/",
    tools: [
      "Vue",
      "TypeScript",
      "HTML",
